	...
	<div id="all">
		...
		<div id="navigation">
			...
			<p id="chpass"><a href="change_pass.php" >change password</a></p>
			 <a  class="tabs active" href="admin_progent.php"> &nbsp; Add Program &nbsp; </a> 
		...
		<div id="content">
			...
			<h1 class="caption">Add Program </h1>
			
			<form name="form1" method="post" action="admin_campupd.php?cat=prog">
			<table>
				...
				<tr>
					...
					<td>
					<TEXTAREA  ID="txtProg" NAME="txtVal" ROWS=10 COLS=40 > </textarea>
					</td>
				</tr>
